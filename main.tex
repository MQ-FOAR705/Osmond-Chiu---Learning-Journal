...
3. Use faceting to produce a timeline display for interviewdate. You will need to use 'Edit cells' then 'Common transforms' then 'To date' to convert this column to dates.
...
\begin{verbatim} levels(memb_assoc) <- c("No", "Undetermined", "Yes")\end{verbatim}

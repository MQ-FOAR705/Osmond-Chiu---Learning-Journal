...
Result: cd ~, cd ~/data/..,cd, cd ..\par

Objective: Relative Path Resolution\par

Action: If pwd displays /Users/thing, enter in ls -F ../backup,\par
...
.. moves up one file directory to users
/backup would move to /users/backup
- F would list all the 
...
\subsubsection*{12/8/2019 - 8:45pm}
\subsubsubsection*{Homework Exercise}
...
\subsubsection*{16/8/2019 - 2:10pm}
\subsubsubsection*{FOAR705 Week 3 Class}
...
\subsubsection*{16/8/2019 - 3:16pm}
\subsubsubsection*{FOAR705 Week 3 Class - Computational Thinking}
...
\subsubsection*{16/8/2019 - 3:16pm} 
\subsubsubsection*{FOAR705 Week 3 Class - Project Management Notes}
\begin{itemize}

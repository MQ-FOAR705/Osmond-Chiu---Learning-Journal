...
When I attempted to open a PDF via a web browser with a Hypothes.is toolbar, the following came up that recommended changes.
...
I then decided to test what happens if I used the same tag but with capitalisation. It led to the creation of different tags.

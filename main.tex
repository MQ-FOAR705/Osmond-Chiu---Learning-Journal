...
\subsubsection*{Transferring Learning Journal}
...
\textbf{Underscores and bullet points do not work}\\\\
...
\textbf{Commands}\\\\
It was initially unclear how to include commands in LaTex without executing them. I entered 'how to display latex commands in latex' into Google and an Overlaf FAQ page that suggested using  \begin{verbatim}\begin{verbatim} \end{verbatim} \\\\
\textbf{Line breaks}\\\\
I had intially used using  \begin{verbatim}\par\end{verbatim} to create paragraphs but it was not able to create a space between lines. Looking through the FAQ, I found that using the double backslash could do it\\\\
\textbf{Italics}\\\\
